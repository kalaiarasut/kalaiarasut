...
AI-enabled platform for integrating marine datasets at CMLRE, Kochi. Unifies oceanographic, biodiversity, taxonomic, otolith, and eDNA data. Supports automated ingestion, AI-driven analysis, and interactive modules for species identification and morphometrics.

`React 18` `TypeScript` `TailwindCSS` `ShadCN UI` `Leaflet` `Node.js` `Express` `PostgreSQL` `PostGIS` `PyTorch`

[![Live Demo](https://img.shields.io/badge/Live_Demo-marlinhq.vercel.app-58a6ff?style=flat-square)](https://marlinhq.vercel.app)
...
An AI-enhanced online learning platform built for structured courses and smart assessments. Supports video, text, quizzes, and assessments with detailed lesson progress tracking. Includes contextual AI chat for students and AI-assisted quiz generation for admins.
...
[![View All Projects](https://img.shields.io/badge/View_All_Repositories-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/kalaiarasut?tab=repositories)
